            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbar-links">
                    ...
                    <nav class="menu">
                        <ul>
                            ...
                            <li><a class="nav-item nav-link" >EMPRESA <i class="fas fa-angle-down"></i> </a>
                                <ul>
                            ...
                            <li><a class="nav-item nav-link" >SERVIÇOS <i class="fas fa-angle-down"></i> </a>
                                <ul>
                                    <li><a class="nav-item nav-link" <?php $href = $pagina == "index" ? "href='servicos/internet.php'" : "href='../servicos/internet.php'"; echo $href;  ?> >INTERNET</a></li>
                            ...
                            <li><a class="nav-item nav-link" >CONTATO <i class="fas fa-angle-down"></i> </a>
                                <ul>                                    
